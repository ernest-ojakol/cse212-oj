...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The Result was reversed hence causing issues
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The Result was reversed hence causing issues. Additionally, zeroes were not catered for at first. This was corrected
    ...
    // Defect(s) Found: Reversed order but all was fixed
